module CommunitiesHelper
  ...
  def community_slogan_locals
    ...
    looks_link = link_to(t("admin.communities.edit_details.see_how_it_looks_like"), "/?big_cover_photo=true", id: "view_slogan_link", target: :_blank)
  ...
  def community_description_locals
    ...
    looks_link = link_to(t("admin.communities.edit_details.see_how_it_looks_like"), "/?big_cover_photo=true", target: :_blank)
  ...
  def community_search_placeholder_locals
    translations = find_community_customizations(:search_placeholder)
    {
      ...
      input_classes: "",
      info_text: I18n.t("admin.communities.edit_details.edit_community_search_placeholder_description", :see_how_it_looks_like => link_to(t("admin.communities.edit_details.see_how_it_looks_like"), "/", target: :_blank)),
